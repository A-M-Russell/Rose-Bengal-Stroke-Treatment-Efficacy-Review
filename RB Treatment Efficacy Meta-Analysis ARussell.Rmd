...
This analysis is the firs half of a two-part analysis of Rose Bengal stroke literature. The second hald assesses the control group data to determine what methodological variables affect infarct volume. The protocol for both these analyses is available on PROSPERO at http://www.crd.york.ac.uk/PROSPERO/display_record.php?ID=CRD42019115429
...
#library(metaviz) #for visualising funnel plots with power analysis - no longer using sunset funnel plot
